...
<div class="leftNav">
    ...
    <ul id="menu">
        ...
        <li class="b_menu"><a href="<?php echo base_url(); ?>projects" title="" class="active" ><span>Buildings
            ...
            <ul class="sub">
                ...
                <li><a href="<?php echo base_url();?>buildings" title="">View Buildings</a></li>
                <?php if($ci->session->userdata('name_group')==1){
                    echo "<li><a href='#' title='' id='regbuildingform'>Add New Building</a></li>";
                }?>
            </ul>
        </li>

        <li class="l_menu"><a href="<?php echo base_url();?>landlords/view_landlords/<?php echo $ci->session->userdata('building_id');?>" title="" class="active"><span>Landlords
                <?php
                    if($active == 'LL'){
                        echo '<img style="border-radius:20px;float:right;margin-right:5%;background-color:white;" src="'.base_url().'images/updateDone.png"/></span></a>';
                    }else{
            ...
            <ul class="sub">
                ...
                <li><a href="<?php echo base_url(); ?>landlords" title="">View Landlords</a></li>

                <?php if($ci->session->userdata('name_group')==1){
                    echo "<li><a href='#' title='' id='landlordreg'>Add New Landlord</a></li>";
                    echo "<li><a href='#' title='' id='upload_l_pic'>Upload Landlord Picture</a></li>";
                }?>
            </ul>
        </li>


        <li class="m_menu"><a href="<?php echo base_url(); ?>projects" title="" class="active" ><span>Messaging
                <?php
                    if($active == 'MS'){
                        echo '<img style="border-radius:20px;float:right;margin-right:5%;background-color:white;" src="'.base_url().'images/updateDone.png"/></span></a>';
                    }else{
            ...
            <ul class="sub">
                <li><a href="#" title="" id="hhh">Send Messages Dialog</a></li>
                <li><a href="<?php echo base_url(); ?>messages" title="">Send Messages</a></li>
                <li><a href="<?php echo base_url(); ?>messages/view_sent" title="">Sent Messages</a></li>
            </ul>
        </li>
        <?php
        ...
        echo '<li class="x_menu"><a href="'. base_url() .'buildings" title="" class="active"><span>'. $building_name.' ('.$this->session->userdata('currency').')' ;
            ...
            echo "
                <ul class='sub'>
                    ...
                    <li>
                        <a href='" . base_url() . "buildings/addfiles/" . $ci->session->userdata('building_id') . "' title=''>
                    ...
                    <li>
                        <a href='#' title=''>
                            View Building Floors Summary
                        </a>
                    </li>

                    <li>
                        <a href='#' title='' id='rm_balance_edit'>
                            Edit Room Balance
                        </a>
                    </li>
         ...
         echo "<li class='r_menu'><a href='" . base_url() . "buildings' title='' class='active'><span>Reports";
            ...
            <ul class='sub'>
                ...
                <li>
                    <a id='agent_report' href='#' title=''>
                        Agent Report
                    </a>
                </li>

                <li>
                    <a id='pending_report' href='#' title=''>
                        Pending Report
                    </a>
                </li>
            </ul>
    ...
    if($ci->session->userdata('name_group')!= 2){
    echo '<li class="a_menu" id="pp" ><a href="' . base_url() . 'payments" title="" class="active" id="pp1"><span>
                Accounts';
            if($active == 'ACC'){
                echo '<img style="border-radius:20px;float:right;margin-right:5%;background-color:white;" src="'.base_url().'images/updateDone.png"/></span></a>';
            }else{
        ...
        echo '</li>';}else{
        echo '<li class="r_menu"><a href="' . base_url() . 'payments" title="" class="active"><span>
                Schedules';
            if($active == 'ACC'){
                echo '<img style="border-radius:20px;float:right;margin-right:5%;background-color:white;" src="'.base_url().'images/updateDone.png"/></span></a>';
            }else{
            ...
            echo "<ul class='sub'>
                <li>
                    <a href='" . base_url() . "bills/schedule_payment/" . $ci->session->userdata('building_id') . "'>Schedule payments</a>
                </li>
                <li>
                    <a href='" . base_url() . "schedules/view_schedule/" . $ci->session->userdata('building_id') . "'>View Schedules</a>
                </li>
            </ul>";
        echo '</li>';
        }
        ...
        <li class='t_menu'><a href='" . base_url() . "buildings' title='' class='active'><span>Tenants";
            ...
            <ul class='sub'>                
                ...
                if(($ci->session->userdata('name_group')==1)||($ci->session->userdata('name_group')==2)){
                echo "
                <li>
                    <a href='#' id='regtenantform' title=''>
                        Add New Tenant
                    </a>
                </li>
                <li>
                    <a href='#' id='upload_t_pic' title=''>
                        Upload tenant picture
                    </a>
                </li>";}
            echo "
                <li>
                    <a href='" . base_url() . "tenants/view_past_tenants/" . $ci->session->userdata('building_id') . "' title=''>
                        View Past Tenants
                    </a>
                </li>
                <li>
                    <a href='#' id='viewtenDocs' title=''>
                       View Tenant Documents
                    </a>
                </li>
                <li>
                    <a href='#' id='addtenDocs' title=''>
        ...
        <li class='f_menu'><a href='#' title='' class='active'><span>
            Floors";
            if($active == 'FL'){
                echo '<img style="border-radius:20px;float:right;margin-right:5%;background-color:white;" src="'.base_url().'images/updateDone.png"/></span></a>';
            }else{
        ...
        echo '<ul class="sub">';
            foreach ($floor_names as $fl) {
                echo '<li><a href="'. base_url() .'floors/floor/'. $fl['f_id'] .'">'. $fl['flr_name'].'</a></li>';
            }
                echo "<li><a href='#' id='addFloors' title=''>Add More Floors</a></li>";

            echo "</ul>";
    echo '</li>';
        ?>

        <li class="bx_menu"><a href="<?php echo base_url();?>users" title="" class="active"><span>Building Expenses
            <?php
                if($active == 'BE'){
                    echo '<img style="border-radius:20px;float:right;margin-right:5%;background-color:white;" src="'.base_url().'images/updateDone.png"/></span></a>';
                }else{
            ...
            ?>
            <ul class="sub">
                <li><a href="<?php echo base_url();?>expenses/add" title="">Add Building Expense</a></li>
                <li><a href="<?php echo base_url();?>expenses/view" title="">View Building Expenses</a></li>
                <li><a href="<?php echo base_url();?>expenses" title="">View Expenses Codes</a></li>
            </ul>
        </li>
    ...
    <?php } ?>
        ...
        <?php if($ci->session->userdata('name_group')==1){
        echo '
        <li class="s_menu"><a href='.base_url().'users" title="" class="active" ><span>System Managers';
            ...
            <ul class="sub">
                ...
                <li><a href="#" title="" id="adminreg">Add New System User</a></li>

                <li><a href="#" title="" id="upload_user_pic">Upload System User Photo</a></li>

                <li><a href="#" title="" id="agentRegister">Add New Agent</a></li>

                <li><a href="'. base_url().'users" title="">View Managers</a></li>

                <li><a href="'. base_url().'users/view_audit_trail" title="">View Audit Trail</a></li>
...
<!-- Add An Agent Form-->
<div id="agentReg" title="Add New Agent" style="display:none;">
    <form id='agent_reg_form'>
        <table >
            <tr>
                <th>Name </th>
                <td ><input title="Name" type="text" name="regular" id="agentName" value=""/></td>                
            </tr>
            <tr>
                <th>Phone Number</th>
                <td><input title="Phone" type="text" name="regular" id="agentPhone" value="" class="phonenumeric"/></td>
            </tr>
        </table>
    </form>
</div>
...
<!--            <th>Telephone 3:</th>
        ...
        <tr>
            <th>Agent: </th>
            <td style="vertical-align: middle;"><select title="Agent" style="width:260px; max-height: 140px; margin-bottom:5px; margin-top:5px;" class="selectElement" name="select" id="agentName2" tabindex="2">
                </select>
            </td>
        </tr>
    </table>
...
<!--Edit Room Balance Form-->
<div id="room_balance_edit" title="Add Room Balance" style="display:none;">
    <table width="100%">
        <tr>
            <td>Rooms: </td>
            <td style="padding-left: 10px;vertical-align: middle;">
                <select style="width:200px; max-height: 140px; margin-bottom:5px; margin-top:5px;" class="selectElement" name="select" id="balance_rm" tabindex="2">
                    <option value="Select Option">Select Option</option>
                </select>
            </td>
        </tr>
        <tr>
            <td>Credit: </td>
            <td><input id="balance_cr" type="text" class="positivenumeric"/></td>
        </tr>
        <tr>
            <td>Debit: </td>
            <td><input id="balance_dr" type="text" class="positivenumeric"/></td>
        </tr>
    </table>
</div>

<!--Upload Floor Plan Form-->
<div id="fPlanUpload" title="Upload Floor Plan" style="display:none;">
    <div class="field">
        <table>
            <tr>
                <th class="w15 left" for="txtURL15" >Floor Name: </th>
                <td style="vertical-align: middle;padding-left: 10px;">
                    <select style="width:294px; max-height: 140px; margin-bottom:5px; margin-top:5px;" class="selectElement" name="select" id="all_flrs" tabindex="2">
                        <option value="Select Option">Select Option</option>
                    </select>
                    <br><br>
                </td>
            ...
            <tr>
                <th class="w15 left" for="txtURL15">Floor Plan: </th>
                <td style="padding-left: 10px;">
                    <input class="w60" type="file" name="txtURL16" id="txtURL16" width="200px" value=""/><br><br>
                </td>
            </tr>
        </table>
    </div>
...
<!--Upload Landlord Picture Form-->
<div id="lpicupload" title="Upload Landlord Picture" style="display:none;">
    <div class="field">
        <table>
            <tr>
                <th class="w15 left" for="txtURL1" >Landlord Name: </th>
                <td style="vertical-align: middle;padding-left: 10px;">
                    <select style="width:294px; max-height: 140px; margin-bottom:5px; margin-top:5px;" class="selectElement" name="select" id="all_landlords" tabindex="2">
                        <option value="Select Option">Select Option</option>
                    </select>
                    <br><br>
                </td>
            ...
            <tr>
                <th class="w15 left" for="txtURL1">Landlord Picture: </th>
                <td style="padding-left: 10px;">
                    <input class="w60" type="file" name="txtURL1" id="txtURL1" width="200px" value=""/><br><br>
                </td>
            </tr>
        </table>
    </div>
...
<!--Messaging Form-->
<div id="mhhh" title="Messaging" style="display:none;">
    <table width="100%">
        
        <tr>
            <td>To: </td>
            <td><input id="m_to" type="text" /></td>
        </tr>
        <tr>
            <td>Message: </td>
            <td><input id="m_body" type="text"/></td>
        </tr>
    </table>
</div>
<script>
                ...
                click: function(){
                   $.ajax({
                                ...
                                data:{
                                    ...
                                    //destination:"256704931550,256788637061", 
                                    destination:"256704931550", 
                                    source:"Cleave Masereka", 
                                    message:"Hi, its been good working with u for this short time. I honestly wanted to help u about the project, but from the look of things, we are now late. May be next time but for now, I just hav to wish u the best of luck.... good day"},
